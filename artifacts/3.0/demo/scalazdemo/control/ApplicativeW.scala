...
*/
object ApplicativeW {
  import scalaz.control.Applicative._
  ...
  val liftShowReverse = unit[Int => String, PartialType[Function1, Int]#Apply]((_: Int).toString.reverse.mkString)
