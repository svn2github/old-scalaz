...
List(1, 2, 3, 4).appendr[Int, List](0, _ + _, List(7, 8, 9))
34
...
List(1, 2, 4, 5).filterM[List, List](n => (1 to n).map(even).toList)
...
Array(1, 4, 5).filterM[List, Array](n => (1 to n).map(even).toList)
...
Array(1, 4, 5).filterM[List, Option](n => (1 to n).map(even).toList)
...
List(1, 2).foldM[Int, List](3, (a, b) => (1 to a + b).toList)
...
object FoldRightW {
  ...
  val demoes = List(
    ...
    // appendr
    ("List(1, 2, 3, 4).appendr[Int, List](0, _ + _, List(7, 8, 9))", List(1, 2, 3, 4).appendr[Int, List](0, _ + _, List(7, 8, 9))),
    ...
    // filterM
    ("List(1, 2, 4, 5).filterM[List, List](n => (1 to n).map(even).toList)", List(1, 2, 4, 5).filterM[List, List](n => (1 to n).map(even).toList)),
    ("Array(1, 4, 5).filterM[List, Array](n => (1 to n).map(even).toList)", Array(1, 4, 5).filterM[List, Array](n => (1 to n).map(even).toList)),
    ("Array(1, 4, 5).filterM[List, Option](n => (1 to n).map(even).toList)", Array(1, 4, 5).filterM[List, Option](n => (1 to n).map(even).toList)),

    // foldM
    ("List(1, 2).foldM[Int, List](3, (a, b) => (1 to a + b).toList)", List(1, 2).foldM[Int, List](3, (a, b) => (1 to a + b).toList))
  )
