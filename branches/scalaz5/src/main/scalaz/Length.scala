...
object Length {
  ...
  implicit val IdentityLength: Length[Identity] = new Length[Identity] {
  ...
  implicit val ZipStreamLength: Length[ZipStream] = new Length[ZipStream] {
    def len[A](a: ZipStream[A]) = a.value.length
  }

  implicit val Tuple1Length: Length[Tuple1] = new Length[Tuple1] {
    def len[A](a: Tuple1[A]) = 1
  }

  implicit val Function0Length: Length[Function0] = new Length[Function0] {
    def len[A](a: Function0[A]) = 1
  }

  implicit val OptionLength: Length[Option] = new Length[Option] {
