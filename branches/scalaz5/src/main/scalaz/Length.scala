...
object Length {
  ...
  implicit lazy val IdentityLength: Length[Identity] = new Length[Identity] {
  ...
  implicit lazy val ZipStreamLength: Length[ZipStream] = new Length[ZipStream] {
    def len[A](a: ZipStream[A]) = a.value.length
  }

  implicit lazy val Tuple1Length: Length[Tuple1] = new Length[Tuple1] {
    def len[A](a: Tuple1[A]) = 1
  }

  implicit lazy val Function0Length: Length[Function0] = new Length[Function0] {
    def len[A](a: Function0[A]) = 1
  }

  implicit lazy val OptionLength: Length[Option] = new Length[Option] {
  ...
  implicit lazy val GenericArrayLength: Length[GArray] = new Length[GArray] {
    def len[A](a: GArray[A]) = a.length
  }

  implicit lazy val IterableLength: Length[Iterable] = new Length[Iterable] {
  ...
  implicit lazy val JavaIterableLength: Length[java.lang.Iterable] = new Length[java.lang.Iterable] {
