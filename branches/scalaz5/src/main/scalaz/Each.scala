...
object Each {
  ...
  implicit val StateEach: Each[PartialApply1Of2[State, Unit]#Apply] = new Each[PartialApply1Of2[State, Unit]#Apply] {
  ...
  implicit val Function0Each: Each[Function0] = new Each[Function0] {
    def each[A](e: Function0[A], f: A => Unit) = f(e.apply)
  }

  implicit val OptionEachEach: Each[Option] = new Each[Option] {
